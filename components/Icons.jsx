...
export const TelescopeIcon = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m10.065 12.493-6.18 1.318a.934.934 0 0 1-1.108-1.108l1.318-6.18A.934.934 0 0 1 5.2 6.41l4.863 4.863"/><path d="M16.013 7.987 12 12l-1.415-1.414a2 2 0 0 1 0-2.828l2.828-2.828a2 2 0 0 1 2.828 0L17.43 6.343"/><path d="m14 4 6 6"/><path d="m18 2 4 4"/><path d="M17 9.94 21.06 6.06"/><path d="m13 15 5-5"/><path d="M6.5 17.5 12 12"/>
  </svg>
);
